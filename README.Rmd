...
The `mapscanner` package comes with two sample `.jpg` images which can be used
...
[`sf`](https://cran.r-project.org/package=sf)-format representing the convex
hulls constructed around the red lines shown in the above map. Note that the
function automatically distinguishes the two hulls. Finally, we can
plot the result as an interactive map using packages like
...
And our hand-drawn line shown above has been converted to a standard spatial
object able to be analysed in any desired way.
